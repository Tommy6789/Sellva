...
<head>
    ...
    <title>Sellva | Dashboard</title>
    <!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="title" content="Sellva | Dashboard" />
    <meta name="author" content="ColorlibHQ" />
    <meta name="description" content="Sellva" />
    <meta name="keywords" content="Sellva" />
        ...
        <nav class="app-header navbar navbar-expand bg-body">
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"><a href="{{ route('logout') }}" class="nav-link">Logout</a>
                    </li>
