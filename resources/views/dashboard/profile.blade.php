...
<form action="{{ route('updateProfile', $user->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="text-center mb-4">
        <div class="position-relative d-inline-block">
            <img id="profileImage" class="rounded-circle shadow border"
            ...
            <input type="file" name="foto" id="profileInput" class="d-none" accept="image/*">
        </div>
        <br>
        <label for="profileInput" class="btn btn-outline-primary btn-sm mt-2">Change Photo</label>
        <p class="text-muted mt-2" style="font-size: 0.9rem;">Max file size: 3MB (JPEG, PNG, JPG, GIF)</p>
    </div>
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="npwp" class="form-control" placeholder="Enter NPWP"
                    value="{{ old('npwp', $profile->npwp ?? '') }}" maxlength="16">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <input type="text" name="alamat" class="form-control"
                    placeholder="Enter Address" value="{{ old('alamat', $user->alamat ?? '') }}">
                @error('alamat') <small class="text-danger">{{ $message }}</small> @enderror
            </div>
            <div class="col-md-12 mt-3">
                <label class="form-label">Phone Number</label>
                <input type="text" name="nomor_telepon" class="form-control"
                    placeholder="Enter Phone Number" value="{{ old('nomor_telepon', $user->nomor_telepon ?? '') }}">
